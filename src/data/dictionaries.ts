export const dictionaries = {
  en: {
      ...
      jobs: [
        {
          ...
          description: "Designed and deployed a data platform consolidating 20,000+ SKUs. Built workflows using TypeScript and SQL. Optimized PostgreSQL with GIN indexes, achieving sub-200ms response times. Implemented Relational Modeling and RLS.",
          skills: ["PostgreSQL", "TypeScript", "SQL", "Data Engineering"],
        ...
        },
        {
          ...
          location: "São Paulo, SP (Hybrid)",
          description: "Led the development of 'Passa a Bola' (MVP) using Flutter and Firebase. Designed Cloud Firestore structures. Automated match updates via public API. Managed Git workflows and enforced Clean Code practices.",
      ...
      items: [
        {
          ...
          description: "Data platform consolidating 20,000+ SKUs, eliminating data fragmentation. Reduced proposal preparation time by ~90%.",
          fullDescription: [
        ...
        },
        {
          slug: "passa-bola",
          title: "Passa a Bola",
          description: "Cross-platform app to professionalize women's football. Reduced manual data collection for clubs by 70%.",
          fullDescription: [
        ...
        },
        {
          ...
          description: "Modern SPA portfolio built with Next.js, Tailwind CSS and Framer Motion. Features i18n and Dark Mode.",
          fullDescription: [
          ...
          gallery: [
             "/images/projects/portfolio-website/gallery-1.svg"
          ],
    ...
    skills: {
      ...
      categories: [
        ...
        { name: "Databases", items: ["PostgreSQL", "Firebase", "MongoDB", "Supabase"] },
  ...
  pt: {
    ...
    about: {
      title: "Sobre Mim",
      summary: "Líder e desenvolvedor experiente focado em Python, TypeScript, algoritmos e estruturas de dados. Histórico comprovado na liderança de projetos acadêmicos e corporativos, notadamente as iniciativas 'Passa a Bola' e 'Catálogo Unentel'. Atualmente atuando como Estagiário de Pré-Vendas e Desenvolvedor Líder na Unentel Distribuição.",
    },
    experience: {
      title: "Experiência",
      jobs: [
        {
          ...
          description: "Projetei e implantei uma plataforma de dados consolidando mais de 20.000 SKUs. Construí fluxos de trabalho usando TypeScript e SQL. Otimizei o PostgreSQL com índices GIN, alcançando tempos de resposta abaixo de 200ms. Implementei Modelagem Relacional e RLS.",
        ...
        },
        {
          ...
          location: "São Paulo, SP (Híbrido)",
          description: "Liderei o desenvolvimento do 'Passa a Bola' (MVP) usando Flutter e Firebase. Projetei estruturas no Cloud Firestore. Automatizei atualizações de partidas via API pública. Gerenciei fluxos de trabalho Git e apliquei práticas de Clean Code.",
      ...
      items: [
        {
          ...
          description: "Plataforma de dados consolidando mais de 20.000 SKUs, eliminando a fragmentação de dados. Reduziu o tempo de preparação de propostas em ~90%.",
          fullDescription: [
        ...
        },
        {
          slug: "passa-bola",
          title: "Passa a Bola",
          description: "Aplicativo multiplataforma para profissionalizar o futebol feminino. Reduziu a coleta manual de dados para clubes em 70%.",
          fullDescription: [
    ...
    skills: {
      ...
      categories: [
        ...
        { name: "Banco de Dados", items: ["PostgreSQL", "Firebase", "MongoDB", "Supabase"] },
